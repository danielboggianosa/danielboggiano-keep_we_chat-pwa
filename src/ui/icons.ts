/** Inline Lucide SVG icons used in the UI */
...
export const icons = {
  ...
  house: svg('<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>'),
  ...
  arrowLeft: svg('<path d="m12 19-7-7 7-7"/><path d="M19 12H5"/>', 20),
  chevronRight: svg('<path d="m9 18 6-6-6-6"/>', 18),
  pause: svg('<rect width="4" height="16" x="6" y="4"/><rect width="4" height="16" x="14" y="4"/>', 24),
  square: svg('<rect width="18" height="18" x="3" y="3" rx="2"/>', 28),
  flag: svg('<path d="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z"/><line x1="4" x2="4" y1="22" y2="15"/>', 24),
